...
namespace db_ops
{
	driver::ResultSet select(driver::Connection & con, std::string const & def_table)
	{
		...
		std::string const table = utils::takeInput("tableName: ",def_table);
		std::string const cols = utils::takeInput("columnName(s): ","*");
		std::string const where = utils::takeInput("condition: ");
	...
	int insert(driver::Connection & con, std::string const & def_table)
	{
		...
		std::string const table = utils::takeInput("tableName: ",def_table);
		std::string const cols = utils::takeInput("colName(s): ");
		std::string const values = utils::takeInput("value(s): ");
	...
	int update(driver::Connection & con, std::string const & def_table)
	{
		...
		std::string const table = utils::takeInput("tableName: ",def_table);
		std::string const setClause = utils::takeInput("setClause: ");
		std::string const where = utils::takeInput("condition: ");
